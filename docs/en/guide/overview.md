...
破晓 Daybreak is an open-source red team collaboration workbench built around multi-expert agent collaboration for authorized penetration testing, vulnerability discovery, code auditing, and security research.
...
| --- | --- | --- | --- |
| `cso` | 破晓 Daybreak | Chief Security Lead | Task decomposition, team coordination, result integration |
