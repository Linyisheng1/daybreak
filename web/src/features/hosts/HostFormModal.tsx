...
const TLS_OPTIONS = [
  { label: UI_TEXT.plain, value: "plain" },
  { label: UI_TEXT.tls, value: "tls" },
];

const CERT_FIELDS = [
  { field: "docker_client_ca_cert", label: UI_TEXT.dockerCaCert },
  { field: "docker_client_cert", label: UI_TEXT.dockerClientCert },
  { field: "docker_client_key", label: UI_TEXT.dockerClientKey },
] as const;
...
export function HostFormModal({ open, host, saving, onCancel, onCreate, onUpdate }: HostFormModalProps) {
  ...
  return (
    <ResourceModal
      open={open}
      title={editing ? UI_TEXT.editHost : UI_TEXT.createHost}
      saving={saving}
      submitLabel={editing ? UI_TEXT.save : UI_TEXT.create}
    ...
    >
      ...
      <div className="host-form-row">
        ...
        <label>
          <span>{UI_TEXT.hostPassword}</span>
      ...
      <div className="host-form-row">
        ...
        <label>
          <span>{UI_TEXT.dockerTlsMode}</span>
          <Select
