  ...
  if (agents.length === 0) {
    return (
      <div className="agent-picker agent-picker-empty">
        <Bot size={14} />
        <span>{UI_TEXT.noAgentsAvailable}</span>
      </div>
    );
  }

  return (
    <div className="agent-picker" role="listbox" aria-label={UI_TEXT.pickAgent}>
      <div className="agent-picker-hint">{UI_TEXT.pickAgent} · ↑↓ 导航 · Enter 或 Tab 确认</div>
