...
This file defines the canonical product terminology shared by 破晓 Daybreak and XuanWu.
...
- Keep product names distinct: `破晓 Daybreak` for upstream, `XuanWu` / `玄武` for the
