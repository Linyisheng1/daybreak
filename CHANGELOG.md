...
- Initial public preview release of 破晓 Daybreak.
...
- Runtime configuration uses local `.daybreak/config.json`, with `.daybreak/config.json.example` as the tracked template.
